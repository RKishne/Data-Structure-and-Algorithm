...
public class Main {
  ...
  public static int max(Node node) {
    // write your code here
    //by tertriary operator
    //return (node==null ? node.data : max(node.right));
  ...
  public static int min(Node node) {
    // write your code here
    //return (node==null ? node.data : min(node.left));
  ...
  public static boolean find(Node node, int data) {
    ...
    if (node.data == data) return true; else if (data < node.data) return find(
      node.left,
      data
